const countries: { [key: string]: Array<string> } = {
  ...
  "CD-KA": ["Katanga"], // deleted
  "CD-BN": ["Bandundu "], // deleted
  "CD-KW": ["Kasai-Occidental"], // deleted
  "CD-OR": ["Orientale"], // deleted
  ...
  "LC-10": ["Soufrière"],
  "LC-11": ["Vieux Fort"],
  "LC-04": ["Dauphin"], // deleted
  "LC-09": ["Praslin"], // deleted
  ...
  "TT-SFO": ["San Fernando"],
  // "TT-TOB": ["Tobago"],
  "TT-ETO": ["Eastern Tobago"], // deleted
  "TT-RCM": ["Rio Claro-Mayaro"], // deleted
  "TT-WTO": ["Western Tobago"], // deleted
  TV: ["Tuvalu", "ツバル"],
  "TV-FUN": ["Funafuti"],
  "TV-NMG": ["Nanumaga"],
  "TV-NMA": ["Nanumea"],
